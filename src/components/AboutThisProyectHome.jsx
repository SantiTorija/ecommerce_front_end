          ...
          <div>
            <div style={{ width: "80%" }} className="" id="aboutHome">
              <p style={{ lineHeight: "2rem" }} className="fs-5 w-100 " id="aboutHome2">
                Hack Wines es un e-commerce 100% funcional (sin fines comerciales), impulsado como
                proyecto integrador del web developer bootcamp, dictado por Hack Academy, instituto
